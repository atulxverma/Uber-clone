...
const Home = () => {
  return (
    <div>
        <div className='bg-cover bg-bottom bg-[url(https://i.pinimg.com/736x/95/ef/61/95ef6196a96de39d92cf033867dc0505.jpg)] pt-8 h-screen w-full flex justify-between flex-col bg-red-400'>
