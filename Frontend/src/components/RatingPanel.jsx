...
const RatingPanel = (props) => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between px-2 pb-4 border-b-2 mb-4">
        ...
        <button onClick={() => navigate('/home')} className="bg-gray-100 h-10 w-10 rounded-full flex items-center justify-center">
  ...
  src={props.ride?.captainId?.profilePic || "https://upload.wikimedia.org/wikipedia/commons/a/ac/Default_pfp.jpg"}
  alt="captain"
/>
        </div>
